...
var AppComponent = (function () {
    ...
    AppComponent.prototype.addStars = function (newStarCount) {
        this.userService.addStar(newStarCount);
    };
    AppComponent.prototype.removeStars = function (removeStarCount) {
    ...
    AppComponent.prototype.getNewQuestionSet = function (forWhom, levelIn) {
        this.questionsService.getNewQuestionSet(forWhom, levelIn);
    };
    AppComponent.prototype.getNewQuestion = function (forWhom, levelIn) {
        if (forWhom === "User") {
